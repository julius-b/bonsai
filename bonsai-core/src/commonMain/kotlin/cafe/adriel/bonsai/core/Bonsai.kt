...
import bonsai.bonsai_core.generated.resources.Res
import bonsai.bonsai_core.generated.resources.chevron_right_24px
...
@Immutable
data class BonsaiScope<T> internal constructor(
...
data class BonsaiStyle<T>(
    val toggleIcon: NodeIcon<T> = { painterResource(Res.drawable.chevron_right_24px) },
